...
<head>
    ...
    <title>Processing Update Payment</title>
    <script>
...
<body>
    <%
        ...
        try {
            ...
            String updateQuery = "UPDATE Payment SET payment_Status = ? WHERE payment_IdPayment = ?";
            ...
            if (rowsUpdated > 0) {
                ...
                out.println("showAlert('Payment status updated successfully!', 'display.jsp');");
                out.println("</script>");
            } else {
                out.println("<script type='text/javascript'>");
                out.println("showAlert('Error updating payment status.', 'display.jsp');");
                out.println("</script>");
            }
