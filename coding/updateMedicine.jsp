...
<body>
    <div class="container">
        ...
        <form method="get" action="updateMedicine.jsp">
            ...
            if (medicationCategory != null && !medicationCategory.isEmpty()) {
                ...
                try {
                    ...
                    if (resultSet.next()) {
                        ...
                        out.println("<form action='updateMedicineProcess.jsp' method='post' onsubmit='return validateForm()'>");
                        ...
                        out.println("<input type='number' id='medication_Quantity' name='medication_Quantity' value='" + medicationQuantity + "' required>");
                        out.println("</div>");
